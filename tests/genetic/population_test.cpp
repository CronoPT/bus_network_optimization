...
TEST_F(population_test, population_empty_constructor_test) {
	...
	ASSERT_EQ(sol1, _population.nth_best(3));
	ASSERT_EQ(sol2, _population.nth_best(2));
	ASSERT_EQ(sol3, _population.nth_best(0));
	ASSERT_EQ(sol4, _population.nth_best(1));
}
...
TEST_F(population_test, population_clip_odd_test) {
	...
	ASSERT_EQ(sol1, _population.nth_best(2));
